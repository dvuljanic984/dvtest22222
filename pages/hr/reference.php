<?php echo webHelper::renderLayout("pageHeader",array("headerClass"=>"work-header","headerTitle"=>"RADOVI","subheaderText"=>"Our name says it all. We’re into software."));?>
...
<section class="page-content">
				...
				<div class="work-case case-viac">
					<div class="row">
						...
						<div class="reveal full reveal-case-study viac-case-reveal" id="caseStudyViac" data-reveal data-close-on-click="true">
							...
							<?php echo webHelper::renderLayout("case-studies-hr/case-viac");?>
				...
				<div class="work-case case-jobclub">
					<div class="row">
						...
						<div class="reveal full reveal-case-study jobclub-case-reveal" id="caseStudyJobClub" data-reveal data-close-on-click="true">
							...
							<?php echo webHelper::renderLayout("case-studies-hr/case-jobclub");?>
	...
	<div class="content-section">
		<header class="text-center">
			<h2 class="section-title">Web stranice sa aplikativnim riješenjima</h2>
		</header>
	...
	<div class="content-section">
		<header class="text-center">
			<h2 class="section-title">Ostale reference</h2>
		</header>
